  ...
  return (
    <>
      <section className='home-section'>
        ...
        <p>You agree <b>not</b> to upload, post, or share any content that is:</p>
        <ul>
        ...
        <p>This app is currently in <b>experimental / early development phase.</b></p>
        <p>This means:</p>
        <ul>
            ...
            <li>your posts, likes, drafts, or profile data are <b>not guaranteed to be permanently stored</b></li>
        </ul>
        ...
        <p>However, by posting on the platform, you grant us a non-exclusive, worldwide license to:</p>
        <ul>
        ...
        <p>You are responsible for making sure your content does not violate copyright or other laws.</p>

        <h4>4. Forking & Derivatives</h4>

        <p>Users may “fork” or remix your bytebeat expressions unless you explicitly mark your post as non-forkable.</p>
        <p>Forks:</p>
        <ul>
        ...
        <p>As this is an experimental service, <b>data may be removed without notice</b>.</p>

        <h4>7. No Sensitive or Personal Data</h4>

        <p>This platform is not designed to store or process sensitive information.</p>
        <p>You agree <b>not to upload, post, or include</b> in your content any:</p>
        <ul>
        ...
        <p>We are not responsible for the exposure, misuse, or loss of sensitive data posted in violation of these terms.</p>
